...
/*
*  WP_Scaffolding_Update
*
*  This class enables WP Scaffolding to update itself like plugins from the WordPress codex would
**
*/

class WP_Scaffolding_Update
{
    var $settings;
    ...
    */
    ...
    function __construct()
    {
        ...
        $this->settings = array(
            'version'   =>  '',
            'remote'    =>  'https://rawgithub.com/UpTrendingLLC/wp-scaffolding/master/wp-scaffolding-update-info.html',
